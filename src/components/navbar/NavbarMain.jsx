...
const NavbarMain = () => {
  ...
  return (
    <nav className="max-w-[1300px] mx-auto w-full  px-4 fixed left-[50%] -translate-x-[50%] z-20 flex gap-4 mt-2">
      <div style={{ backgroundColor: 'hsl(180deg 60.13% 38.16%)' }} className="flex  px-4 justify-between w-full max-w-[1200px] mx-auto  bg-black items-center  rounded-r-full rounded-l-full border-orange border-[0.5px] ">
        <NavbarLogo />
